...
<body>
    <header>
        ...
        <?php require __DIR__ . '/views/partials/auth_section.php'; ?> <? // logowanie i wyświetlanie informacji o aktualnym użytkowniku ?>
    </header>
    ...
    <div class="container">
        <div class="view active">
            ...
            <?php else: ?>
                <?php require __DIR__ . '/views/partials/messages.php'; ?> <? // wyświetlanie komunikatów o rezerwacji lub błędach rezerwacji ?>
                ...
                <?php require __DIR__ . '/views/partials/create_event_modal.php'; ?> <? // modal dodawania wydarzenia (tylko dla administratora) ?>

                <div class="events-grid">
                    <?php require __DIR__ . '/views/partials/event_card.php'; ?> <? // karty wydarzeń z przyciskiem rezerwacji (tylko dla zalogowanych użytkowników) ?>
                </div>

                <?php require __DIR__ . '/views/partials/reservation_modal.php'; ?> <? // modal rezerwacji miejsc (tylko dla zalogowanych użytkowników) ?>
            <?php endif; ?>
        </div>
    </div>
